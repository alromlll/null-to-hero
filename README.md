...
> Roadmap: 14 semanas | Inicio: Febrero 2026
...
| PC (Proxmox)  | Hipervisor / VMs           | Proxmox VE                |
...
> Las IPs estáticas se configurarán en la Semana 1. Se actualizará este diagrama con los valores reales.
...
| Herramienta     | Estado       |
|-----------------|--------------|
| Terminal Linux  | ⬜ En progreso |
| Bash scripting  | ⬜ Pendiente  |
| SSH             | ⬜ Pendiente  |
| Nginx           | ⬜ Pendiente  |
| Docker          | ⬜ Pendiente  |
| Proxmox         | ⬜ Instalando |
...
|--------|--------|------------|
| 1 — Preparación | 🔄 En curso | README + Proxmox con VM corriendo |
| 2 — Permisos y servicios | ⬜ | Guía de permisos en GitHub |
| 3 — Almacenamiento | ⬜ | Disco montado + lsblk/df -h |
| 4 — Bash scripting | ⬜ | 3 scripts + crontab |
...
*Última actualización: Semana 1 — Febrero 2026*
